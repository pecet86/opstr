...
Otwarta Polska Sieæ Tras Rowerowych
...
* stworzyæ bazê danych ze Ÿród³a pliku SQL (dostêpne w póŸniejszym terminie)
* skopiowaæ do jednego folderu
* skonfigurowaæ plik lib/ustawienia.php w dostêpnie do bazy danych
$baza_nazwa, $baza_uzytkownik, $baza_host = 'localhost', $bazw_haslo

# Je¿eli na localhost nie dzia³a to
Za komentowaæ w pliku .htaccess linijki od 43 to 54
Dodaæ rozszerzenie ".php" w plikach:
...
Projekt ten zosta³ wydany na licencji GNU General Public License 3.0+. Zobacz do³¹czony pliku licencji dla szczegó³ów.
